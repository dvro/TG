...
Por sua vez o CNN, de alto poder de redução, reduziu demais a classe minoritária, mas como foi utilizado o 3-NN, obteve taxa de acerto média de 0.00\% para esta classe, enquanto a marjoritária obteve 100\% de acerto.
...
O OSS, obteve uma taxa de acerto total inferior as técnicas citadas anteriormente, sendo 78.58\% em média. Todavia, observa-se que a taxa de acerto da base minoritária foi de 70\%, maior que a do KNN. A quantidade de protótipos selecionados pelo OSS foi em média apenas 10.43\% do conjunto de treinamento original. Isso mostra que, mesmo com um nível de desbalanceamento maior, \textit{One-Sided Selection} tem um alto poder de redução e prioriza a classe minoritária.
