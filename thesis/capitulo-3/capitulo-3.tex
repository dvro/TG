...
\caption{ENN com 10\% da classe minoritária}
\label{tab:enn10}
\end{table}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{ENN com 5\% da classe minoritária}
\label{tab:enn5}
\end{table}
...
\caption{ENN sobre base com total sobreposição de classes e 10\% da classe minoritária}
\label{fig:enn1015}
\end{figure}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{CNN com 10\% da classe minoritária}
\label{tab:cnn10}
\end{table}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{CNN com 5\% da classe minoritária}
\label{tab:cnn5}
\end{table}
...
\caption{CNN sobre base sem sobreposição de classes e 5\% da classe minoritária}
\label{fig:cnn50}
\end{figure}
...
\caption{CNN sobre base com sobreposição III de classes e 5\% da classe minoritária}
\label{fig:cnn55}
\end{figure}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{Tomek Links com 10\% da classe minoritária}
\label{tab:tl10}
\end{table}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{Tomek Links com 5\% da classe minoritária}
\label{tab:tl5}
\end{table}
...
\caption{Tomek Links sobre base com sobrep. III de classes e 10\% da  minoritária}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{OSS com 10\% da classe minoritária}
\label{tab:oss10}
\end{table}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{OSS com 5\% da classe minoritária}
\label{tab:oss5}
\end{table}
...
\caption{OSS com sobreposição III de classes e 10\% da classe minoritária}
\label{fig:oss55}
\end{figure}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{LVQ 1 com 10\% da classe minoritária}
\label{tab:lvq110}
\end{table}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{LVQ1 com 5\% da classe minoritária}
\label{tab:lvq15}
\end{table}
...
\caption{LVQ 1 com sobreposição III de classes e 5\% da classe minoritária}
\label{fig:lvq155}
\end{figure}
...
\caption{LVQ 1 com sobreposição V de classes e 5\% da classe minoritária}
\label{fig:lvq1515}
\end{figure}
...
\caption{LVQ 1 com sobreposição V de classes e 10\% da classe minoritária}
\label{fig:lvq11015}
\end{figure}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{LVQ 2.1 com 10\% da classe minoritária}
\label{tab:lvq210}
\end{table}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{LVQ 2.1 com 5\% da classe minoritária}
\label{tab:lvq25}
\end{table}
...
\center
  ...
  \caption{LVQ 1 e 2.1 com sobreposição I de classes e 10\% da classe minoritária}
  \label{fig:lvqcomp}
\end{figure}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{LVQ 3 com 10\% da classe minoritária}
\label{tab:lvq310}
\end{table}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{LVQ 3 com 5\% da classe minoritária}
\label{tab:lvq35}
\end{table}
...
\caption{LVQ 3 sem sobreposição de classes e 10\% da classe minoritária}
\label{fig:lvq3100}
\end{figure}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{SGP 1 com 10\% da classe minoritária}
\label{tab:sgp110}
\end{table}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{SGP 1 com 5\% da classe minoritária}
\label{tab:sgp15}
\end{table}
...
\caption{SGP 1 com total sobreposição de classes e 5\% da classe minoritária}
\label{fig:sgp1515}
\end{figure}
...
Observando as tabelas \ref{tab:sgp210} e \ref{tab:sgp25}, percebe-se que o SGP 2 obteve uma excelente taxa de acerto geral, porém, a taxa de acerto da classe minoritária é altamente prejudicada no momento da generalização. As possíveis adaptações para este problema já foram citados na sub-sessão anterior.
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{SGP 2 com 10\% da classe minoritária}
\label{tab:sgp210}
\end{table}
...
\end{tabular}%--- fechamento do ambiente tabular
\end{center}   %fim da centralização da tabela
\caption{SGP 2 com 5\% da classe minoritária}
\label{tab:sgp25}
\end{table}
...
\caption{SGP 2 com total sobreposição de classes e 5\% da classe minoritária}
\label{fig:sgp2515}
\end{figure}
